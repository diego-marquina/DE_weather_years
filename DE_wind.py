...
#     group_name="DE_weather_years_2022",
#     start="2022-01-01",
#     end="2023-01-01", 
#     granularity='hours'
#     )
...
# df_epsi.columns = df_epsi.columns.str.replace('1Base_Wx-Years.Germany.Generation.All.','',regex=True)

# df_epsi.index = df_epsi.index.tz_localize('Europe/Berlin', nonexistent='shift_forward', ambiguous='True')

#%%
df_epsi_capacity = pd.read_csv(r'capacities.csv')
df_epsi_capacity.set_index('Unnamed: 0', inplace=True)
df_epsi.index.name = 'date'
df_epsi_capacity = df_epsi_capacity['REA_WIND_METEO_DE']
# %%
...
curves = eq.metadata.curves(q='DE Wind Power Production MWh/h 15min Climate')
